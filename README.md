...
## 四、 决策拦截与反幻觉机制 (Decision Interception & Anti-Hallucination)
...
## 五、 Godot 专属文件与场景规范 (Godot-Specific File & Scene Protocols)
...
## 七、 破坏性修改与版本控制确认 (Destructive Changes & VCS Check)
